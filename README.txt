...
possible occupancy, as well as determining if there is a coloured cell (not used in the
COMP329 2020 programming assignment).  Each cell is characterised using the enum CellOccupancyType.
