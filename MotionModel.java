// File: MotionModel.java
// Date: 31st Dec 2020
// Description: Motion Model for COMP329 Programming Assignment (2020)
// Author: Terry Payne
// Modifications:

/**
 * The motion model provides all of the details of the robots motion, including
 * tracking odometry, etc, as well as modelling where the robot is believed to
 * move to based on a noise model etc.
 * Based on the code developed in Worksheet 3 for COMP329, Nov 2020
 *
...
// A framework has been provided, but the correct values should be
// calculated, which shoud result in the robot moving around the
// mapDisplay, and correct figures appear in the Odometry Display.
//
// Remember that even if the odometry update works, the robot that
// appears on the map Display will accumulate localisation errors.
// ==============================================================
...
public class MotionModel {
  ...
  public Pose updateOdometry(double leftPositionSensorValue, double rightPositionSensorValue) {
    ...
    // and right velocities, based on the COMP329 notes on Locomotion and Kinematics
    ...
    // Declare other variables used in managing the odometry.
    ...
    double velocity = 0.0;    // Forward velocity
    ...
    double icr_y = 0.0;       // ICR y coordinate (y)
      ...
      // ...
      // ... 
      // Find the pose of the robot at each time interval (i.e. generate
      // a new pose based on the old pose and change in odometry) by determining
      // the forward and angular velocity of the robot based
      // on the changes over time of the wheel encoders.  Use the values
      // dl and dr for the veolicies of the left and right wheels respectively.
